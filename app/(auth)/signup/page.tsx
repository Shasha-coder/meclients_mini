    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-muted text-sm mt-2">Create your free account</p>
        </div>
        <div className="bg-white rounded-3xl border border-surface-border shadow-lifted p-8">
          <form onSubmit={handleSignup} className="space-y-4">
            <div>
              <label className="text-xs font-medium text-ink-muted uppercase tracking-wide block mb-2">Business name</label>
