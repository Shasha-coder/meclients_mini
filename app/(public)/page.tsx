...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center" style={{
      ...
      <nav className="w-full px-10 pt-6 flex justify-between items-center">
        ...
        <div className="notranslate" style={{ marginRight: '6vw', filter: 'drop-shadow(0 4px 12px rgba(46,184,122,0.08))' }}>
          <LanguageSwitcher />
        </div>
      </nav>
